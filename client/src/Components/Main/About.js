  ...
  return (
    <div className="px-6 md:px-12 lg:px-24 py-10 bg-gray-100">
      <p className="text-4xl font-bold text-center text-blue-500 underline mb-8">
        OrganLelo: A Platform for Connecting Organ Donors and Recipients
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white shadow-lg rounded-lg p-6 transition-transform transform hover:scale-105">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            OrganLelo serves as a comprehensive platform where users can
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 transition-transform transform hover:scale-105">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            OrganLelo plays a critical role in managing and tracking organ
